        ...
        <>
          ...
          <div 
            ...
            style={{
              ...
              top: `${avatarBubblePosition.y}px`
            }}
          >
            {/* Arrow pointing down */}
            <div className="absolute top-full left-1/2 transform -translate-x-1/2 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-gray-800"></div>
            
            <div className="bg-gray-800/95 backdrop-blur-xl rounded-lg border border-white/20 shadow-2xl p-3 min-w-48">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <div>
                  <div className="text-white font-medium text-sm">{showAvatarBubble.nickname}</div>
                  <div className="text-gray-400 text-xs">Click pentru acțiuni</div>
                </div>
              </div>
              ...
              <div className="flex space-x-2">
                <button
                  ...
                  className="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-3 py-2 rounded-lg text-sm transition-colors duration-200 flex items-center justify-center space-x-1"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                  </svg>
